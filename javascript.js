...
var result ={
    ...
    "ISTJ": {"genre":"클래식",  "subtitle":"기본에 충실한 그래서 더 빛나는 모범생",  "chemibox":"", "explain":"",     "audio":"bgm/모차르트  세레나데 제13번 '아이네 클라이네 나흐트무지크' G장조 K (mp3cut.net).mp3"},
    ...
    "INTP": {"genre":"인디",     "subtitle":"난 조용히 나만의 길을 간다 자발적 아웃사이더",   "chemibox":"", "explain":"",     "audio":"bgm/사람은 이상하고 사랑은 모르겠어 (mp3cut.net).mp3"},
    "INTJ": {"genre":"포크",     "subtitle":"차가워 보이지만 들어보면 따뜻할 걸?",  "chemibox":"", "explain":"",     "audio":"bgm/너무 아픈 사랑은 사랑이 아니었음을 (mp3cut.net).mp3"},
